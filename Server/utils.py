...
from .config import PLATFORM_DISPLAY_NAMES, MODEL_DISPLAY_NAMES, DEFAULT_MODELS
...
def build_model_option(platform_name: str, platform_config: dict, model_name: str) -> dict:
    ...
    return {
        ...
        'label': f"{get_platform_display_name(platform_name)} - {get_model_display_name(model_name)}",
