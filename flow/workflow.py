...
from Item.FlowTools import FlowEngine, NodeFactory
from Item.Agentlib import Agent, AgentRole, ModelFactory, ModelConfig
from core.agent_factory import AgentFactory, AgentCreationConfig, AgentCreationMode
from core.config_manager import ConfigManager
from Item.Agentlib.Tools import CalculatorTool, FileTool, WebSearchTool, CodeExecutorTool
...
class WorkflowBuilder:
    ...
    def _get_default_model_for_platform(self, platform: str) -> str:
        """获取平台的默认模型"""
        default_models = {
            'zhipu': 'glm-4.5',  # 🔧 修改为 glm-4.5，确保使用联网功能
