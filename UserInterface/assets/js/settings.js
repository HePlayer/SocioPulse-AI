...
class SettingsManager {
    ...
    getDefaultSettings() {
        return {
            models: {
                default_platform: 'zhipu',  // 优先使用智谱AI（有免费模型）
                platforms: {
                    openai: {
                        api_key: '',
                    ...
                    zhipu: {
                        ...
                        available_models: ['glm-4', 'glm-4-plus', 'glm-3-turbo', 'glm-4-flash-250414', 'glm-4.5'],
                        enabled_models: ['glm-4', 'glm-4-plus', 'glm-3-turbo', 'glm-4-flash-250414', 'glm-4.5'],
