...
class EnhancedZhipuAIAdapter(EnhancedModelAdapter):
    ...
    def _initialize_clients(self):
        ...
        try:
            ...
            self.zai_client = ZhipuAiClient(api_key=self.config.api_key)
            self.logger.info("智谱AI官方SDK (zai) 初始化成功")
        except ImportError:
            self.logger.warning("智谱AI官方SDK (zai) 不可用")
        ...
        try:
            ...
            self.logger.info("ZhipuAI备用SDK初始化成功")
        except ImportError:
            self.logger.warning("zhipuai SDK不可用")
            self.zhipu_client = None
        ...
        try:
            ...
            self.logger.warning("openai SDK不可用")
            self.openai_client = None
    ...
    async def _call_with_zhipu_sdk(self, messages: List[Dict[str, str]], **kwargs) -> ModelResponse:
        ...
        # 🌐 默认启用联网功能
        params["tools"] = [{"type": "web_search", "web_search": {"enable": true}}]
        params["tool_choice"] = "auto"
        self.logger.info("ZhipuAI SDK: 默认启用联网功能")
